export const html = `
  ...
  <aside class="notes">
    Présenter la problématique centrale du mémoire.
    Contextualiser : digitalisation, commerce en ligne, sans contact.
    Méthodologie : veille technologique (BCE, BRI, rapports institutionnels).
    Citation Lalucq : urgence d'un Airbus des paiements européens.
  </aside>
`;
